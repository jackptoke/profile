...
const projects = [
    {
        ...
        content: <div>This website is built using the following technologies:
    ...
    {
        title: "Ruby on Rails",
        content: <div>Qonnect is a website connecting interpreters and their clients.  The following are the technologies being used to create it:
        <ol className='green-text'>
...
class Portfolio extends React.Component{
    ...
    renderPortfolio = () => {
        ...
        return <div className="portfolio-page">
            <h1 className="portfolio-title">{projects[project_number]["title"]}</h1>
            ...
            <div className="portfolio-arrows"> 
                <div className="right-arrow-container"><i class={`fas fa-arrow-right ${this.state.right_arrow}`} onMouseOver={this.toggleArrow} onMouseOut={this.toggleArrow} onClick={this.next}></i></div>
                <div className="left-arrow-container"><i class={`fas fa-arrow-left ${this.state.left_arrow}`}  onMouseOver={this.toggleArrow} onMouseLeave={this.toggleArrow} onClick={this.previous}></i></div>
            </div>
        </div>;
    }
